...
class Mesh
{
	...
	void _normalBind()
	{
      ...
      public:
	Mesh(glm::vec3 color) : _modelMat(1.0f), _colors(color)
	...
	void update(float s, glm::vec3 p, glm::vec3 o)
	{
		...
		_modelMat = glm::rotate(_modelMat, glm::radians(o.x),
					glm::vec3(1.0f, 0.0f, 0.0f));
		_modelMat = glm::rotate(_modelMat, glm::radians(o.y),
					glm::vec3(0.0f, 1.0f, 0.0f));
		_modelMat = glm::rotate(_modelMat, glm::radians(o.z),
