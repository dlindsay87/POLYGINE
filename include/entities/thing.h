...
namespace ENT {
	...
	public:
		...
		void draw(DISPLAY::Shader* shader, DISPLAY::Light* light, DISPLAY::Window* window, glm::vec3 camPos) {
			shader->use();
		...
		void reflect(DISPLAY::Shader* shader, DISPLAY::Light* light, DISPLAY::Window* window, POLY::Mesh* mesh) {
			shader->use();
